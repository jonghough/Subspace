...
public final class Zeta {
    ...
    /**
     * Returns <i>Zeta(-n)</i> for positive integer, <i>n</i>, greater than 1.
     * @param n positive integer
     * @return zeta value
     */
    public static double zetaMN(int n) {
        if (n < 2) throw new IllegalArgumentException("Argument n must be greater than 1, to calculate zeta(-n).");
        Rational bernoulli = BernoulliNumbers.calculateNthBernoulliNumber(n + 1);
        return bernoulli.toDouble() / (n + 1);
    }
}
